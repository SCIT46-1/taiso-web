          ...
          <Link to={`/club/${club.clubId}`} className="flex-1">
            <div className="w-full flex items-center px-4 py-2 relative">
              ...
              {club.clubProfileImageId === null ? (
                ...
                <img
                  src={`https://taiso-web-gpx-file-space-korea.s3.ap-northeast-2.amazonaws.com/${club.clubProfileImageId}`}
                  alt={club.clubName}
              ...
              <div className="flex flex-col p-2 ml-2">
                <div className="flex flex-col">
                  ...
                  <div className="text-sm text-gray-500 mt-1 max-w-[200px] truncate overflow-hidden">
