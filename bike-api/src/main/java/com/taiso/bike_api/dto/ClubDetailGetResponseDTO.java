...
//     @Builder.Default
//     private List<ClubDetailGetResponseBoardDTO> boards = new ArrayList<>();
...
//                                     //    .currentScale(entity.getCurrentScale())
//                                        .users(entity.getUsers().stream().map(user -> ClubDetailGetResponseUserDTO.toDTO(user)))
//                                        .tags(entity.getTags())
//                                        .boards(ClubDetailGetResponseBoardDTO.toDTO(entity.getBoards()))
//                                        .build();
//     }
// }
